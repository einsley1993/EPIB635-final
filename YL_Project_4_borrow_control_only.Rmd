---
title: "Project 4: borrow control arm only"
author: "Yi Li"
date: "27/11/2022"
output:
...
trial = function(TE, 
  ...
  repeat {
    ...
    p_success = c(p_success, pbetabinom.ab(q = 117, 
                                           size = 264, 
                                           shape1 = ai, 
                                           shape2 = bi, 
                                           log = FALSE))
...
# 2. Trial simulation: add MAP (borrow historical control arm only)
  ...
  repeat {
    ...
    p_success = c(p_success, 
                   wb*pbetabinom.ab(q = 117, 
                                    size = 264, 
                                    shape1 = ai + 226, # yi = 226 = no. of cases in ctrl arm
                                    shape2 = bi + (226 + 180) - 226,  # ni - yi 
                                    log = FALSE) + 
